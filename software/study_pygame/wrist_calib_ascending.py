...
class Calibration_ascending:
    def __init__(self):
        ...
        self.vib_lvl = 0
        self.step = config.wrist_threshold / 4
        ...
        self.counter = 1
    def run(self):
        print('Starting the wrist ascending calibration...')
        ...
        config.wrist_threshold = round((config.wrist_threshold + threshold_value)/2, 3)
